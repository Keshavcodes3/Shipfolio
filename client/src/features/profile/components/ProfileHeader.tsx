    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link to="/discover" className="text-[11px] uppercase tracking-[0.15em] text-[#555B55] hover:text-[#F5F7F2] transition-colors duration-200">
            DISCOVER
          </Link>
          <Link to="/explore" className="text-[11px] uppercase tracking-[0.15em] text-[#555B55] hover:text-[#F5F7F2] transition-colors duration-200">
            EXPLORE
          </Link>
          <Link to={`/profile/${username}/edit`} className="text-[11px] uppercase tracking-[0.15em] text-[#B6F34A] hover:text-[#c8ff66] transition-colors duration-200">
            EDIT PROFILE
          </Link>
        </div>
          ...
          >
            ...
            <div className="flex-1 flex flex-col items-center justify-center gap-8">
              {[
                ...
                { to: `/profile/${username}/edit`, label: 'EDIT PROFILE', accent: true },
              ].map((item, i) => (
                <motion.div
                  key={item.label}
